...
//! videos, PDFs, audio, Office Open XML documents, and validated legacy
//! PowerPoint presentations with native total-size ceilings; there is no
//! general file reader. All
...
pub use preview::{
    ...
    MAX_OFFICE_PREVIEW_BYTES, MAX_PDF_PREVIEW_BYTES, MAX_PREVIEW_BYTES, MAX_VIDEO_PREVIEW_BYTES,
    MEDIA_CHUNK_BYTES, MediaChunk, MediaInfo, MediaKind, PreviewKind, PreviewLineEnding,
    PreviewResult, PreviewUnsupportedReason,
};
pub use settings::{
