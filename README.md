...
<p align="center">
  <a href="https://github.com/Rice-dog/code-codex/releases/tag/v0.2.2"><img alt="Version" src="https://img.shields.io/badge/version-0.2.2-blue"></a>
...
- Recommended: `CodeCodex-0.2.2-x64-setup.exe`
- Alternative: `CodeCodex-0.2.2-x64.msi`
- Portable package: `CodeCodex-0.2.2-x64.zip`
- Standalone uninstaller: `Uninstall-CodeCodex.exe`

You can verify downloads with:

```powershell
Get-FileHash .\CodeCodex-0.2.2-x64-setup.exe -Algorithm SHA256
```
