...
<p align="center">
  <a href="https://github.com/Rice-dog/code-codex/releases/tag/v0.2.56"><img alt="版本" src="https://img.shields.io/badge/version-0.2.56-blue"></a>
...
- 推荐：`CodeCodex-0.2.56-x64-setup.exe`
- 备选：`CodeCodex-0.2.56-x64.msi`
- 便携包：`CodeCodex-0.2.56-x64.zip`
...
- Codex 顶部 Help 右侧增加 Code-Codex 菜单，可显示或隐藏文件树并打开预览市场。
- Codex 侧边栏中的本地工作区文件树。
