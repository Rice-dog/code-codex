...
`CodeCodex-0.1.0-demo.mp4` is a 1920×1080, 30 fps, exactly 90-second
...
npm ci
npm run lint
npx remotion render CodeCodex90 ../docs/demo/CodeCodex-0.1.0-demo.mp4 --codec h264 --crf 22 --muted
```
