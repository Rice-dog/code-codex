...
<p align="center">
  <a href="https://github.com/Rice-dog/code-codex/releases/tag/v0.1.71"><img alt="版本" src="https://img.shields.io/badge/version-0.1.71-blue"></a>
...
- 推荐：`CodeCodex-0.1.71-x64-setup.exe`
- 备选：`CodeCodex-0.1.71-x64.msi`
- 便携包：`CodeCodex-0.1.71-x64.zip`
- 独立卸载程序：`Uninstall-CodeCodex.exe`

可以用下面的命令校验下载文件：

```powershell
Get-FileHash .\CodeCodex-0.1.71-x64-setup.exe -Algorithm SHA256
```
