...
<p align="center">
  <a href="https://github.com/Rice-dog/code-codex/releases/tag/v0.1.33"><img alt="版本" src="https://img.shields.io/badge/version-0.1.33-blue"></a>
...
可以从 [GitHub Releases](https://github.com/Rice-dog/code-codex/releases/tag/v0.1.33)
下载已经生成好的安装包：

运行环境要求：Windows 10 版本 2004（build 19041）或更高版本、x64，
并已安装官方稳定版 Codex/ChatGPT Desktop。

- 推荐：[`CodeCodex-0.1.33-x64-setup.exe`](https://github.com/Rice-dog/code-codex/releases/download/v0.1.33/CodeCodex-0.1.33-x64-setup.exe)
- 备选：[`CodeCodex-0.1.33-x64.msi`](https://github.com/Rice-dog/code-codex/releases/download/v0.1.33/CodeCodex-0.1.33-x64.msi)
- 便携包：[`CodeCodex-0.1.33-x64.zip`](https://github.com/Rice-dog/code-codex/releases/download/v0.1.33/CodeCodex-0.1.33-x64.zip)
- 独立卸载程序：[`Uninstall-CodeCodex.exe`](https://github.com/Rice-dog/code-codex/releases/download/v0.1.33/Uninstall-CodeCodex.exe)
